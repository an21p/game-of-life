...
var G__11271 = devtools.prefs.pref.call(null,v);
v = G__11271;
continue;
} else {
return v;
...
}catch (e11274){var _e__10934__auto__ = e11274;
return false;
}})();
...
}catch (e11278){var _e__10934__auto__ = e11278;
return false;
}})();
...
}catch (e11280){var _e__10934__auto__ = e11280;
return false;
}}
}
});
...
var vec__11282 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__11282,(0),null);
var name = cljs.core.nth.call(null,vec__11282,(1),null);
...
return cljs.core.some.call(null,(function (p1__11285_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__11285_SHARP_);
}),template);
});
