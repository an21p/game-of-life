...
var file = cljs.core.get.call(null,map__11939__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
...
}catch (e11938){var _e = e11938;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___11941 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___11941)){
var seen_errors_11942 = temp__5455__auto___11941;
if(cljs.core.truth_(seen_errors_11942.has(self))){
} else {
seen_errors_11942.add(self);

var temp__5457__auto___11943 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___11943)){
var sense_11944 = temp__5457__auto___11943;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_11944)].join('');
} else {
}
}
} else {
