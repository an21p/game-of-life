...
var o11166 = temp__5455__auto__;
var temp__5455__auto____$1 = (o11166["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o11167 = temp__5455__auto____$1;
return (o11167["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__10927__auto__ = f;
return (o__10927__auto__["toString"]).call(o__10927__auto__);
} else {
return "";
}
}catch (e11168){var _ = e11168;
return "";
}});
...
try{var o__10927__auto___11170 = t;
(o__10927__auto___11170["cljs$lang$ctorPrWriter"]).call(o__10927__auto___11170,t,writer);
}catch (e11169){var __11171 = e11169;
}
...
var char_code = (function (){var o__10927__auto__ = (new String(char$));
return (o__10927__auto__["charCodeAt"]).call(o__10927__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__10927__auto__ = String;
return (o__10927__auto__["fromCharCode"]).call(o__10927__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__11172 = num_code;
switch (G__11172) {
case (1):
return (185);
...
var o__10927__auto__ = String;
return (o__10927__auto__["fromCharCode"]).call(o__10927__auto__,superscript_code);
});
/**
...
}catch (e11174){var _e__10934__auto__ = e11174;
return false;
}})())){
...
var vec__11175 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__11175,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o11178 = temp__5455__auto__;
var temp__5455__auto____$1 = (o11178["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o11179 = temp__5455__auto____$1;
return (o11179["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___11186 = arguments.length;
var i__4731__auto___11187 = (0);
while(true){
if((i__4731__auto___11187 < len__4730__auto___11186)){
args__4736__auto__.push((arguments[i__4731__auto___11187]));

var G__11188 = (i__4731__auto___11187 + (1));
i__4731__auto___11187 = G__11188;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__11182){
var vec__11183 = p__11182;
var ns_detector = cljs.core.nth.call(null,vec__11183,(0),null);
...
var G__11189 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__11190 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__11189;
remaining_tokens = G__11190;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq11180){
var G__11181 = cljs.core.first.call(null,seq11180);
var seq11180__$1 = cljs.core.next.call(null,seq11180);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11181,seq11180__$1);
});
...
var vec__11194 = cljs.core.split_with.call(null,(function (p1__11193_SHARP_){
return cljs.core.not_EQ_.call(null,p1__11193_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__11194,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__11194,(1),null);
...
var vec__11200 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__11200,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__11200,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__11203 = cljs.core.rest.call(null,remaining_tokens);
var G__11204 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__11203;
name_tokens = G__11204;
continue;
} else {
...
var vec__11207 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__11207,(0),null);
var arity = cljs.core.nth.call(null,vec__11207,(1),null);
var vec__11210 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__11210,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__11210,(1),null);
var vec__11213 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__11213,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__11213,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__11213,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__11213,(3),null);
...
var vec__11219 = result;
var munged_ns = cljs.core.nth.call(null,vec__11219,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__11219,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__11219,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__11219,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__11219,(4),null);
var arity = cljs.core.nth.call(null,vec__11219,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__11223 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__11223,(0),null);
var args = cljs.core.nth.call(null,vec__11223,(1),null);
var vec__11226 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__11226,(0),null);
var name = cljs.core.nth.call(null,vec__11226,(1),null);
...
var G__11229 = (arity + (1));
var G__11230 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__11231){
var vec__11232 = p__11231;
var arity = cljs.core.nth.call(null,vec__11232,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__11232,(1),null);
...
return cljs.core.get.call(null,arities,p1__11235_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__11236_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__11239){
var vec__11240 = p__11239;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__11240,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq11237){
var G__11238 = cljs.core.first.call(null,seq11237);
var seq11237__$1 = cljs.core.next.call(null,seq11237);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__11238,seq11237__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__11248__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__11248__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__11248__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__11248__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__11249 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__11249,(0),null);
var fn_name = cljs.core.nth.call(null,vec__11249,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__11249,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__11249,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__11249,(4),null);
var arity = cljs.core.nth.call(null,vec__11249,(5),null);
...
var o__10927__auto__ = f;
return (o__10927__auto__["getBasis"]).call(o__10927__auto__);
});
/**
...
}catch (e11253){var _e__10934__auto__ = e11253;
...
var G__11254 = (obj[cljs.core.first.call(null,path)]);
var G__11255 = cljs.core.rest.call(null,path);
obj = G__11254;
path = G__11255;
continue;
} else {
...
return (function (accum,p__11256){
var vec__11257 = p__11256;
var bit = cljs.core.nth.call(null,vec__11257,(0),null);
var protocol = cljs.core.nth.call(null,vec__11257,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__11260){
var vec__11261 = p__11260;
var ns = cljs.core.nth.call(null,vec__11261,(0),null);
var name = cljs.core.nth.call(null,vec__11261,(1),null);
var selector = cljs.core.nth.call(null,vec__11261,(2),null);
...
return (function (p__11265){
var vec__11266 = p__11265;
var munged_name = cljs.core.nth.call(null,vec__11266,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__11266,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__11266,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__11264_SHARP_){
return (obj[cljs.core.first.call(null,p1__11264_SHARP_)]);
});})(name,sorted_matches,vec__11266,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
